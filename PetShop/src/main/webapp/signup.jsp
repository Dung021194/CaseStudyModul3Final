			...
			<div class="col-md-7 col-lg-5">
				<div class="login-wrap">
					...
					<form action="signupAccount" method="post" class="signup-form">
						...
						<div class="form-group mb-3">
							<%--@declare id="name"--%><label class="label" for="name">Phone Number</label>
							<input type="text" name="phoneNumber" class="form-control" placeholder="0989999999">
							<span class="icon fa fa-user-o"></span>
						</div>
						<div class="form-group mb-3">
							<%--@declare id="name"--%><label class="label" for="name">Address</label>
